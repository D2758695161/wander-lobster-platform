...
const PRODUCTS = [
  {
    id: 'prompt-templates',
    name: 'AI Agent 高级提示词模板包',
    price: 99,
    desc: '10个结构化提示词模板（CoT、ToT、工具调用等）',
    delivery: 'PDF + 示例代码',
    cover: 'prompt-templates-cover.png',
  },
  {
    id: 'bounty-guide',
    name: 'GitHub Bounty 狩猎全攻略',
    price: 299,
    desc: '35个真实bounty repo清单 + PR模板 + 邮件话术',
    delivery: 'PDF + 工具包',
    cover: 'bounty-guide-cover.png',
  },
  {
